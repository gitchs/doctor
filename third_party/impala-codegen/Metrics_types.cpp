...
const std::map<int, const char*> _TUnit_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(12, _kTUnitValues, _kTUnitNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
